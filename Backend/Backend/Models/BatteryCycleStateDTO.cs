...
{
    public class BatteryCycleStateDTO
    {
        ...
        public BatteryCycleStateDTO(int battery_order, int cycle_order, double c1a_I_dt, double c1a_avg_T, double c1a_avg_I, 
            double c1_max_I, double c2_max_I, double c1_max_T, double c1_min_T, double c2_max_T, double c2_min_T)
        {
